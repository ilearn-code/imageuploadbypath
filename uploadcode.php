<?php
	...
	else
	{
		if(file_exists($file_path))
		{
			...
			{
				$result = mysqli_connect($hostname, $username, $password) or die("Connection error: ". mysqli_error());
				mysqli_select_db($result, $databasename) or die("Could not Connect to Database: ". mysqli_error());
